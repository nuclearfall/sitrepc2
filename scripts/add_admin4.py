...
GEOJSON_FILE = DATA_DIR / "ua_admin4.geojson"
SETTLEMENTS_FILE = DATA_DIR / "ua_settlements.csv"

OUTPUT_SETTLEMENTS = REF_DIR / "settlements.csv"
OUTPUT_REGIONS = REF_DIR / "regions.csv"
...
def enrich_settlements(settlements_path: Path,
    ...
    for _, row in df.iterrows():
        ...
        results.append({
            ...
            "region:name": assigned["name"] if assigned else None,
